...
Author: Grok (2025-12-11) – Weaving axioms into verse where necessity bends.
"""
...
class OutputHandler:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        - tone: 'technical', 'poetic', 'auto' (uses classifier).
        """
    ...
    def _infuse_tone(self, formatted: str, tone: str) -> str:
        """Transform formatted string: technical (concise, labeled); poetic (rhythmic, metaphorical wrappers)."""
        if tone == 'technical':
